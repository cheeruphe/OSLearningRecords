...
> ```
 ...
 ![image-20230403110145730](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230403110145730.png)
...
fn calculate_length(s: &String) -> usize {
 ...
 ![image-20230403110749165](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230403110749165.png)

 ![image-20230403111008349](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230403111008349.png)

 **可变引用**

我们通过一个小调整就能修复示例 4-6 代码中的错误，允许我们修改一个借用的值，这就是 **可变引用**（*mutable reference*）：

![image-20230403111912156](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230403111912156.png)

首先，我们必须将 `s` 改为 `mut`。然后在调用 `change` 函数的地方创建一个可变引用 `&mut s`，并更新函数签名以接受一个可变引用 `some_string: &mut String`。这就非常清楚地表明，`change` 函数将改变它所借用的值。

可变引用有一个很大的限制：如果你有一个对该变量的可变引用，你就不能再创建对该变量的引用。这些尝试创建两个 `s` 的可变引用的代码会失败：

![image-20230403111852603](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230403111852603.png)
...
![image-20230403112200377](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230403112200377.png)
...
![image-20230403112952281](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230403112952281.png)
...
![image-20230403113501837](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230403113501837.png)

![image-20230403113714719](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230403113714719.png)

![image-20230403113752362](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230403113752362.png)

### 4.3 Slice类型

**字符串 slice**（*string slice*）是 `String` 中一部分值的引用，它看起来像这样：

![image-20230403115005423](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230403115005423.png)
...
![image-20230403115026505](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230403115026505.png)



![image-20230403115511506](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230403115511506.png)

![image-20230403120220542](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230403120220542.png)
...
![image-20230403121758848](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230403121758848.png)
...
![image-20230403200103530](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230403200103530.png)

![image-20230403200222725](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230403200222725.png)

![image-20230403200559623](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230403200559623.png)

![image-20230403203751404](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230403203751404.png)
...
![image-20230404094314393](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404094314393.png)
...
![image-20230404094338950](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404094338950.png)
...
![image-20230404094655395](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404094655395.png)

示例 5-3：改变 `User` 实例 `email` 字段的值

![image-20230404095058936](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404095058936.png)
...
![image-20230404095322614](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404095322614.png)
...
![image-20230404095906818](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404095906818.png)
...
![image-20230404101520957](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404101520957.png)
...
![image-20230404102531338](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404102531338.png)
...
![image-20230404102922390](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404102922390.png)

编译器会报需要生命周期标识符的错误。

### 5.2 结构体示例程序

![image-20230404103741420](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404103741420.png)

使用元组重构上面的代码，实现求长方形面积。上面的参数看不出关联性。

![image-20230404103950835](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404103950835.png)

使用结构体重构：赋予更多意义。我们使用结构体为数据命名来为其赋予意义。我们可以将我们正在使用的元组转换成一个有整体名称而且每个部分也有对应名字的结构体。

![image-20230404104104948](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404104104948.png)
...
![image-20230404105146827](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404105146827.png)
...
![image-20230404105503796](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404105503796.png)
...
![image-20230404105429238](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404105429238.png)
...
![image-20230404105845526](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404105845526.png)
...
![image-20230404110421794](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404110421794.png)
...
![image-20230404111306328](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404111306328.png)
...
![image-20230404111700332](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404111700332.png)

![image-20230404111945434](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404111945434.png)
...
![image-20230404112300724](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404112300724.png)
...
![image-20230404112451637](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404112451637.png)
...
![image-20230404112759960](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404112759960.png)

**枚举值**

可以像这样创建 `IpAddrKind` 两个不同成员的实例：

![image-20230404113005069](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404113005069.png)

注意枚举的成员位于其标识符的命名空间中，并使用两个冒号分开。这么设计的益处是现在 `IpAddrKind::V4` 和 `IpAddrKind::V6` 都是 `IpAddrKind` 类型的。例如，接着可以定义一个函数来获取任何 `IpAddrKind`：

![image-20230404113104844](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404113104844.png)

![image-20230404113214516](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404113214516.png)
...
![image-20230404113436149](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404113436149.png)
...
![image-20230404113647508](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404113647508.png)
...
![image-20230404114226844](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404114226844.png)
...
![image-20230404115032200](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404115032200.png)
...
![image-20230404115144183](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404115144183.png)
...
![image-20230404115514975](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404115514975.png)
...
![image-20230404120832853](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404120832853.png)
...
![image-20230404121205471](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404121205471.png)
...
![image-20230404121425562](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404121425562.png)
...
![image-20230404150613402](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404150613402.png)
...
![image-20230404151040945](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404151040945.png)

**匹配Some(T)**

![image-20230404151550696](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404151550696.png)

**匹配是穷尽的**

![image-20230404151941635](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404151941635.png)

我们没有处理 `None` 的情况，所以这些代码会造成一个 bug。幸运的是，这是一个 Rust 知道如何处理的 bug。

**通配模式和占位符**

![image-20230404165040663](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404165040663.png)
...
![image-20230404165239628](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404165239628.png)

最后，让我们再次改变游戏规则，如果你掷出 3 或 7 以外的值，你的回合将无事发生。

![image-20230404165428563](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404165428563.png)

### 6.3 if let 简介控制流

![image-20230404165958580](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404165958580.png)
...
![image-20230404170018765](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404170018765.png)
...
![image-20230404171001783](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404171001783.png)



![image-20230404222141671](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230404222141671.png)
